...
## Adding new features 
You can extend the current contract to include more featres to enhance our smart contract. Below, we will include a decrement, multiply and reset features to our contract.

### Decrement the Counter

You  can decrease the counter value by clicking the "Decrement Counter" button. This sends a transaction to the smart contract to decrement the counter by 1.
...
To multiply the counter value, you enter a multiplier in the input field and click the "Multiply Counter" button. This sends a transaction to multiply the current counter value by the specified multiplier.
...
The "Reset Counter" button sets the counter back to 0. This feature allows you to start over without manually decrementing or incrementing the counter to reach the default value of 0.
...
Finally, You can disconnect your wallet by clicking the "Disconnect Wallet" button. This is useful for security purposes and when switching between different wallet accounts.
...
There you have it! We just added more features to our smartcontract.
